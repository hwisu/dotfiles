...
FISH_SOURCE_LINE="source $HOME/.gen_envs.sh"

mkdir -p "$FISH_CONFIG_DIR"

if [ -f "$FISH_CONFIG_FILE" ]; then
    if ! grep -q "$FISH_SOURCE_LINE" "$FISH_CONFIG_FILE"; then
        echo "\n# Source environment variables generated by .gen_envs.sh" >> "$FISH_CONFIG_FILE"
    ...
    echo "# Source environment variables generated by .gen_envs.sh" > "$FISH_CONFIG_FILE"
    echo "$FISH_SOURCE_LINE" >> "$FISH_CONFIG_FILE"
